...
// ServerWallet represents a server wallet implementation
...
// Ensure ServerWallet implements Wallet interface
var _ Wallet = (*ServerWallet)(nil)

// NewServerWallet creates a new server wallet
func NewServerWallet() (*ServerWallet, error) {
	return &ServerWallet{
		Wallet:   nil,
		accounts: []account.Account{},
		clients:  ChainClients{},
...
func (w *ServerWallet) loadAccountIntoWallet(ctx context.Context, account account.Account, network network.Network) error {
...
func (w *ServerWallet) Accounts() []account.Account {
	return w.accounts
}

func (w *ServerWallet) Clients() ChainClients {
	return w.clients
}

// CreateAccount creates a new Account using local key generation
func (w *ServerWallet) CreateAccount(ctx context.Context) (*account.Account, error) {
	newAccount, err := account.NewServerAccount()
	if err != nil {
...
func (w *ServerWallet) GetAccount(ctx context.Context, address ids.ShortID) (*account.Account, error) {
...
func (w *ServerWallet) ListAccounts(ctx context.Context) ([]*account.Account, error) {
...
func (w *ServerWallet) ImportAccount(ctx context.Context, keyPath string) (*account.Account, error) {
...
func (w *ServerWallet) BuildTx(ctx context.Context, params BuildTxParams) (tx.BuildTxResult, error) {
...
func (w *ServerWallet) SignTx(ctx context.Context, params SignTxParams) (tx.SignTxResult, error) {
	if err := w.loadAccountIntoWallet(ctx, params.Account, params.Network); err != nil {
...
func (w *ServerWallet) SendTx(ctx context.Context, params SendTxParams) (tx.SendTxResult, error) {
	if err := w.loadAccountIntoWallet(ctx, params.Account, params.Network); err != nil {
...
func (w *ServerWallet) SignPChainTx(ctx context.Context, unsignedTx avagoTxs.UnsignedTx, account account.Account) (*avagoTxs.Tx, error) {
...
func (w *ServerWallet) GetAddresses(ctx context.Context) ([]ids.ShortID, error) {
...
func (w *ServerWallet) GetChainClients() ChainClients {
	return w.clients
}

// SetChainClients updates the blockchain clients for this wallet
func (w *ServerWallet) SetChainClients(clients ChainClients) {
	w.clients = clients
}

// Close performs cleanup operations for the wallet
func (w *ServerWallet) Close(ctx context.Context) error {
	// TODO: Implement cleanup logic if needed
	return nil
}

// AddAccount adds an Account to the wallet
func (w *ServerWallet) AddAccount(acc account.Account) {
	w.accounts = append(w.accounts, acc)
}

// GetAccountByAddress finds an Account by its address
func (w *ServerWallet) GetAccountByAddress(address ids.ShortID) *account.Account {
...
func (w *ServerWallet) GetAllAccounts() []account.Account {
	return w.accounts
}

func (w *ServerWallet) buildPChainTx(ctx context.Context, account account.Account, params BuildTxInput) (tx.BuildTxResult, error) {
...
func (w *ServerWallet) buildConvertSubnetToL1Tx(ctx context.Context, account account.Account, params *txs.ConvertSubnetToL1TxParams) (tx.BuildTxResult, error) {
...
// buildConvertSubnetToL1Tx builds a ConvertSubnetToL1Tx transaction
func (w *ServerWallet) buildCreateSubnetTx(ctx context.Context, params *txs.CreateSubnetTxParams) (tx.BuildTxResult, error) {
...
func (w *ServerWallet) buildCChainTx(ctx context.Context, params BuildTxInput) (tx.BuildTxResult, error) {
...
func (w *ServerWallet) buildXChainTx(ctx context.Context, params BuildTxInput) (tx.BuildTxResult, error) {
	// TODO: Implement X-Chain transaction building
	return tx.BuildTxResult{}, fmt.Errorf("X-Chain transactions not yet implemented")
}

func (w *ServerWallet) Commit(transaction tx.SignTxResult) (*avagoTxs.Tx, error) {
