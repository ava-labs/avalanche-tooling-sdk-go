...
func (h *Host) ValidateComposeFile(composeFile string, timeout time.Duration) error {
...
func (h *Host) ComposeSSHSetupLoadTest() error {
	return h.ComposeOverSSH("Compose Node",
		constants.SSHScriptTimeout,
		"templates/avalanchego.docker-compose.yml",
		dockerComposeInputs{
...
func (h *Host) WasNodeSetupWithMonitoring() (bool, error) {
...
func (h *Host) ComposeSSHSetupMonitoring() error {
...
func (h *Host) ComposeSSHSetupAWMRelayer() error {
